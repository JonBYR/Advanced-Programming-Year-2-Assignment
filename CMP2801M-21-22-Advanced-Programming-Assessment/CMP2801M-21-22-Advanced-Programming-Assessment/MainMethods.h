...
public:
	...
	static void convert(int& intValue, string numericString);
	static void convert(double& floatValue, string numericString) throw (IncorrectDouble); //function overloading
};
